    ...
    <div className='product-container'>
            ...
            <div className="flex justify-between items-start gap-5 flex-wrap pb-6">
              ...
              <div className="flex items-center gap-3">
                <div className="product-hearts">
                  <Image src={'/assets/icons/red-heart.svg'} alt='heart' width={20} height={20}></Image>
                  <p className="text-base font-semibold text-[#D46F77]">{product.reviewsCount}</p>
                </div>

                <div className="p-2 bg-white-200 rounded-10">
                  <Image src={'/assets/icons/bookmark.svg'} alt='bookmark' width={20} height={20}></Image>
                </div>
                <div className="p-2 bg-white-200 rounded-10">
                  <Image src={'/assets/icons/share.svg'} alt='bookmark' width={20} height={20}></Image>
                </div>
              </div>
            </div>
                ...
                <div className="flex flex-col gap-4">
                  <div className="flex gap-3">
                    ...
                    <div className="product-reviews">
                      <Image src={'/assets/icons/comment.svg'} alt='comment' height={16} width={16}/>
                      <p className='text-sm text-secondary font-semibold'>{product.reviewsCount} Reviews</p>
                    </div>
                  </div>

                  <p className='text-sm text-black opacity-50'>
                    <span className='text-primary-green font-semibold'>93.1%</span> of buyers have recomended this.
                  </p>
                </div>
            </div>
        ...
        <div className="flex flex-col gap-16 border-red-500">
          <div className="flex flex-col gap-5">
            <h1 className="text-2xl text-secondary font-semibold">Product Desciption</h1>
            <div className="flex flex-col gap-4">
